...
public class ProjectileLine : MonoBehaviour { 
    ...
    public GameObject poi { 
        ...
        set {
            _poi =value ;
            if ( _poi !=null ) {
                // When _poi is set to something new, it resets everything line.enabled = false;
                points = new List<Vector3>();
                AddPoint();
            }
        }
...
// This can be used to clear the line directly
    ...
    public void AddPoint() {
        ...
        if ( points.Count > 0 && (pt - lastPoint).magnitude < minDist ) { // If the point isn't far enough from the last point, it returns 
            return;
        }
